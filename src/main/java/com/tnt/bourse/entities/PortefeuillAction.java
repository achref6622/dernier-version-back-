...
public class PortefeuillAction implements Serializable {
	...
	private List<OrderVente> orderVentes;

	@JsonIgnore
	@OneToMany(mappedBy = "portefeuillAction")
	private List<OrderAchat> orderAchats;
	...
	public List<OrderVente> getOrderVentes() {
		return orderVentes;
	}

	public void setOrderVentes(List<OrderVente> orderVentes) {
		this.orderVentes = orderVentes;
	}

	public List<OrderAchat> getOrderAchats() {
		return orderAchats;
	}

	public void setOrderAchats(List<OrderAchat> orderAchats) {
		this.orderAchats = orderAchats;
	}
